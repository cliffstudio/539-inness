...
// Query: {  id,  hide,  layout,  heading,  body,  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  specs[] {    body  },  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}
...
// Query: {  id,  hide,  heading,  body,  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}
...
// Query: {  id,  hide,  layout,  subHeading,  heading,  body,  image {  asset {    _ref,    _type  },  hotspot,  crop},  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  backgroundColor}
...
// Query: {  id,  hide,  images[] {  asset {    _ref,    _type  },  hotspot,  crop}}
...
// Query: {  id,  hide,  heading,  eventCategories,  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  }}
...
// Query: {  id,  hide,  noTopPad,  noBottomPad}
...
// Query: {  id,  hide,  heading,  products[]-> {    _id,    store {      title,      slug {        current      },      previewImageUrl,      priceRange {        minVariantPrice,        maxVariantPrice      },      status,      isDeleted,      options[] {        name,        values      },      variants[]-> {        store {          inventory {            available,            isAvailable          },          option1,          option2,          option3,          colorHex        }      }    }  }}
...
// Query: {  _type,  ...select(_type == "heroSection" => {  id,  hide,  layout,  heading,  body,  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  specs[] {    body  },  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "textSection" => {  id,  hide,  heading,  body,  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "mediaTextSection" => {  id,  hide,  layout,  heading,  body,  bulletList[] {    body  },  buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  mediaAlignment,  mediaOrientation,  roomLink-> {    _id,    title,    roomType,    description,    "slug": slug.current  },  roomLinks[]-> {    _id,    title,    roomType,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop}  },  activityLinks[]-> {    _id,    title,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop},    bookingHref,    date,    timeRange  },  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  },  links[] {    header,    body,    date,    image {  asset {    _ref,    _type  },  hotspot,  crop},    buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "breakSection" => {  id,  hide,  layout,  subHeading,  heading,  body,  image {  asset {    _ref,    _type  },  hotspot,  crop},  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  backgroundColor}),  ...select(_type == "carouselSection" => {  id,  hide,  images[] {  asset {    _ref,    _type  },  hotspot,  crop}}),  ...select(_type == "menuSection" => {  id,  hide,  layout,  heading,  note,  image {  asset {    _ref,    _type  },  hotspot,  crop},  foodTabs[] {    tabName,    availability,    image {  asset {    _ref,    _type  },  hotspot,  crop},    categories[] {      name,      items[] {        name,        price,        extrasLabel,        extras[] {          name,          price        }      }    }  },  spaTabs[] {    tabName,    image {  asset {    _ref,    _type  },  hotspot,  crop},    treatments[] {      name,      description,      options[] {        duration,        price      }    }  },  venueTabs[] {    areaName,    areaDescription,    image {  asset {    _ref,    _type  },  hotspot,  crop},    specs[] {      specName,      specDescription    }  }}),  ...select(_type == "calendarSection" => {  id,  hide,  heading,  eventCategories,  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  }}),  ...select(_type == "featureSection" => {  id,  hide,  layout,  subHeading,  heading,  feature1 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature2 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature3 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature4 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "bookingSection" => {  id,  hide,  noTopPad,  noBottomPad}),  ...select(_type == "productSection" => {  id,  hide,  heading,  products[]-> {    _id,    store {      title,      slug {        current      },      previewImageUrl,      priceRange {        minVariantPrice,        maxVariantPrice      },      status,      isDeleted,      options[] {        name,        values      },      variants[]-> {        store {          inventory {            available,            isAvailable          },          option1,          option2,          option3,          colorHex        }      }    }  }})}
...
// Source: src/sanity/lib/queries.ts
// Variable: pageQuery
// Query: *[_type == "page" && slug.current == $slug][0] {    _id,    _type,    title,    slug,    pageType,    seo {  metaTitle,  metaDescription,  socialImage {  asset {    _ref,    _type  },  hotspot,  crop}},    textBlocks[] {      _key,      header,      body    },    contentBlocks[] {  _type,  ...select(_type == "heroSection" => {  id,  hide,  layout,  heading,  body,  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  specs[] {    body  },  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "textSection" => {  id,  hide,  heading,  body,  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "mediaTextSection" => {  id,  hide,  layout,  heading,  body,  bulletList[] {    body  },  buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  mediaAlignment,  mediaOrientation,  roomLink-> {    _id,    title,    roomType,    description,    "slug": slug.current  },  roomLinks[]-> {    _id,    title,    roomType,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop}  },  activityLinks[]-> {    _id,    title,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop},    bookingHref,    date,    timeRange  },  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  },  links[] {    header,    body,    date,    image {  asset {    _ref,    _type  },  hotspot,  crop},    buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "breakSection" => {  id,  hide,  layout,  subHeading,  heading,  body,  image {  asset {    _ref,    _type  },  hotspot,  crop},  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  backgroundColor}),  ...select(_type == "carouselSection" => {  id,  hide,  images[] {  asset {    _ref,    _type  },  hotspot,  crop}}),  ...select(_type == "menuSection" => {  id,  hide,  layout,  heading,  note,  image {  asset {    _ref,    _type  },  hotspot,  crop},  foodTabs[] {    tabName,    availability,    image {  asset {    _ref,    _type  },  hotspot,  crop},    categories[] {      name,      items[] {        name,        price,        extrasLabel,        extras[] {          name,          price        }      }    }  },  spaTabs[] {    tabName,    image {  asset {    _ref,    _type  },  hotspot,  crop},    treatments[] {      name,      description,      options[] {        duration,        price      }    }  },  venueTabs[] {    areaName,    areaDescription,    image {  asset {    _ref,    _type  },  hotspot,  crop},    specs[] {      specName,      specDescription    }  }}),  ...select(_type == "calendarSection" => {  id,  hide,  heading,  eventCategories,  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  }}),  ...select(_type == "featureSection" => {  id,  hide,  layout,  subHeading,  heading,  feature1 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature2 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature3 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature4 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "bookingSection" => {  id,  hide,  noTopPad,  noBottomPad}),  ...select(_type == "productSection" => {  id,  hide,  heading,  products[]-> {    _id,    store {      title,      slug {        current      },      previewImageUrl,      priceRange {        minVariantPrice,        maxVariantPrice      },      status,      isDeleted,      options[] {        name,        values      },      variants[]-> {        store {          inventory {            available,            isAvailable          },          option1,          option2,          option3,          colorHex        }      }    }  }})}  }
export type PageQueryResult = {
  ...
  contentBlocks: Array<
    ...
    | {
        ...
        mediaOrientation: "landscape" | "portrait" | null;
        roomLink: {
          _id: string;
          title: string | null;
...
// Query: *[_type == "page" && pageType == "homepage"][0] {    _id,    _type,    title,    slug,    pageType,    seo {  metaTitle,  metaDescription,  socialImage {  asset {    _ref,    _type  },  hotspot,  crop}},    homepageHeading,    homepageMediaType,    homepageImages[] {  asset {    _ref,    _type  },  hotspot,  crop},    homepageVideo,    contentBlocks[] {  _type,  ...select(_type == "heroSection" => {  id,  hide,  layout,  heading,  body,  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  specs[] {    body  },  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "textSection" => {  id,  hide,  heading,  body,  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "mediaTextSection" => {  id,  hide,  layout,  heading,  body,  bulletList[] {    body  },  buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  mediaAlignment,  mediaOrientation,  roomLink-> {    _id,    title,    roomType,    description,    "slug": slug.current  },  roomLinks[]-> {    _id,    title,    roomType,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop}  },  activityLinks[]-> {    _id,    title,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop},    bookingHref,    date,    timeRange  },  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  },  links[] {    header,    body,    date,    image {  asset {    _ref,    _type  },  hotspot,  crop},    buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "breakSection" => {  id,  hide,  layout,  subHeading,  heading,  body,  image {  asset {    _ref,    _type  },  hotspot,  crop},  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  backgroundColor}),  ...select(_type == "carouselSection" => {  id,  hide,  images[] {  asset {    _ref,    _type  },  hotspot,  crop}}),  ...select(_type == "menuSection" => {  id,  hide,  layout,  heading,  note,  image {  asset {    _ref,    _type  },  hotspot,  crop},  foodTabs[] {    tabName,    availability,    image {  asset {    _ref,    _type  },  hotspot,  crop},    categories[] {      name,      items[] {        name,        price,        extrasLabel,        extras[] {          name,          price        }      }    }  },  spaTabs[] {    tabName,    image {  asset {    _ref,    _type  },  hotspot,  crop},    treatments[] {      name,      description,      options[] {        duration,        price      }    }  },  venueTabs[] {    areaName,    areaDescription,    image {  asset {    _ref,    _type  },  hotspot,  crop},    specs[] {      specName,      specDescription    }  }}),  ...select(_type == "calendarSection" => {  id,  hide,  heading,  eventCategories,  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  }}),  ...select(_type == "featureSection" => {  id,  hide,  layout,  subHeading,  heading,  feature1 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature2 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature3 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature4 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "bookingSection" => {  id,  hide,  noTopPad,  noBottomPad}),  ...select(_type == "productSection" => {  id,  hide,  heading,  products[]-> {    _id,    store {      title,      slug {        current      },      previewImageUrl,      priceRange {        minVariantPrice,        maxVariantPrice      },      status,      isDeleted,      options[] {        name,        values      },      variants[]-> {        store {          inventory {            available,            isAvailable          },          option1,          option2,          option3,          colorHex        }      }    }  }})}  }
...
// Source: src/sanity/lib/queries.ts
// Variable: menuQuery
// Query: *[_type == "siteSettings"][0] {    _id,    items[] {      linkType,      label,      href,      pageLink-> {        _id,        title,        "slug": slug.current      }    }  }
...
// Query: *[_type == "room"] | order(title asc) {    _id,    title,    description,    images[] {  asset {    _ref,    _type  },  hotspot,  crop},    specs[] {      body    },    "slug": slug.current,    contentBlocks[] {  _type,  ...select(_type == "heroSection" => {  id,  hide,  layout,  heading,  body,  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  specs[] {    body  },  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "textSection" => {  id,  hide,  heading,  body,  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}}),  ...select(_type == "mediaTextSection" => {  id,  hide,  layout,  heading,  body,  bulletList[] {    body  },  buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  mediaType,  images[] {  asset {    _ref,    _type  },  hotspot,  crop},  video,  mediaAlignment,  mediaOrientation,  roomLink-> {    _id,    title,    roomType,    description,    "slug": slug.current  },  roomLinks[]-> {    _id,    title,    roomType,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop}  },  activityLinks[]-> {    _id,    title,    description,    "slug": slug.current,    images[] {  asset {    _ref,    _type  },  hotspot,  crop},    bookingHref,    date,    timeRange  },  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  },  links[] {    header,    body,    date,    image {  asset {    _ref,    _type  },  hotspot,  crop},    buttons[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "breakSection" => {  id,  hide,  layout,  subHeading,  heading,  body,  image {  asset {    _ref,    _type  },  hotspot,  crop},  button {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }},  backgroundColor}),  ...select(_type == "carouselSection" => {  id,  hide,  images[] {  asset {    _ref,    _type  },  hotspot,  crop}}),  ...select(_type == "menuSection" => {  id,  hide,  layout,  heading,  note,  image {  asset {    _ref,    _type  },  hotspot,  crop},  foodTabs[] {    tabName,    availability,    image {  asset {    _ref,    _type  },  hotspot,  crop},    categories[] {      name,      items[] {        name,        price,        extrasLabel,        extras[] {          name,          price        }      }    }  },  spaTabs[] {    tabName,    image {  asset {    _ref,    _type  },  hotspot,  crop},    treatments[] {      name,      description,      options[] {        duration,        price      }    }  },  venueTabs[] {    areaName,    areaDescription,    image {  asset {    _ref,    _type  },  hotspot,  crop},    specs[] {      specName,      specDescription    }  }}),  ...select(_type == "calendarSection" => {  id,  hide,  heading,  eventCategories,  "activities": *[    _type == "calendar" &&    isActive == true &&    defined(startsAt) &&    startsAt >= now()  ] | order(startsAt asc)[0...50] {    _id,    title,    startsAt,    endsAt,    locationName,    locationAddress,    description,    thumbnail,    bookingHref,    eventCategories,    contentBlocks[] {      _type    },    "slug": slug.current  }}),  ...select(_type == "featureSection" => {  id,  hide,  layout,  subHeading,  heading,  feature1 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature2 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature3 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  },  feature4 {    image {  asset {    _ref,    _type  },  hotspot,  crop},    heading,    body,    links[] {  linkType,  label,  href,  jumpLink,  bookingTab,  color,  file {    asset {      _ref,      _type,      originalFilename    }  },  pageLink {    _ref,    _type,    "slug": *[_type == "page" && _id == ^._ref][0].slug.current,    "title": *[_type == "page" && _id == ^._ref][0].title  }}  }}),  ...select(_type == "bookingSection" => {  id,  hide,  noTopPad,  noBottomPad}),  ...select(_type == "productSection" => {  id,  hide,  heading,  products[]-> {    _id,    store {      title,      slug {        current      },      previewImageUrl,      priceRange {        minVariantPrice,        maxVariantPrice      },      status,      isDeleted,      options[] {        name,        values      },      variants[]-> {        store {          inventory {            available,            isAvailable          },          option1,          option2,          option3,          colorHex        }      }    }  }})}  }
...
// Source: src/sanity/lib/queries.ts
// Variable: productSeoQuery
// Query: *[_type == "product" && store.slug.current == $slug][0] {    seo {  metaTitle,  metaDescription,  socialImage {  asset {    _ref,    _type  },  hotspot,  crop}},    store {      title,      descriptionHtml,      previewImageUrl,      status,      isDeleted    }  }
export type ProductSeoQueryResult = {
  seo: {
    metaTitle: string | null;
    metaDescription: string | null;
    socialImage: {
