...
export default defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'Media with Text (title & small text)', value: 'media-with-text-h4-body' },
          { title: 'Media with Text (room type)', value: 'media-with-text-room-type' },
          { title: 'Media with Text (title & bullet list)', value: 'media-with-text-h4-bullet-list' },
          { title: 'Media with Text (title, text & custom links block)', value: 'media-with-text-h4-body-links' },
          { title: 'Media with Text (big text & room links block)', value: 'media-with-text-h4-body-room-links' },
          { title: 'Media with Text (big text calendar links block)', value: 'media-with-text-h4-body-activity-links' },
          { title: 'Media with Text (multiple text blocks w/ sticky image)', value: 'media-with-text-multiple-text-blocks' },
        ],
      },
    ...
    defineField({
      ...
      title: 'Heading',
      type: 'string',
      hidden: ({ parent }) => parent?.layout !== 'media-with-text-h4-body' && parent?.layout !== 'media-with-text-h4-bullet-list' && parent?.layout !== 'media-with-text-h4-body-links',
    }),
    defineField({
      name: 'body',
      title: 'Body',
