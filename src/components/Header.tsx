...
export default function Header({ menu }: HeaderProps) {
  ...
  return (
    <>
      {/* Desktop header */}
      <header
        className={`site-header site-header-desktop${scrolled ? " scrolled" : ""}${isBookingOpen ? " booking-overlay-open" : ""}`}
        ...
        <div className="nav-wrap">
          <div className="left">
            ...
            <div className="link-icon account-icon">
              ...
              <a
                href="https://members.inness.co/page/login"
                target="_blank"
                rel="noopener noreferrer"
              ></a>
            </div>
          ...
          {menu.items.length > 0 && (
            <div className={navClassName}>{renderNavLinks()}</div>
          )}

          <div
            className="right"
            onClick={() =>
              isBookingOpen ? closeBooking() : openBooking("room")
            }
          >
      ...
      {/* Tablet header */}
      <header
        className={`site-header site-header-tablet${scrolled ? " scrolled" : ""}${isBookingOpen ? " booking-overlay-open" : ""}`}
        suppressHydrationWarning
      >
      ...
      {/* Mobile header */}
      <header
        className={`site-header site-header-mobile${scrolled ? " scrolled" : ""}${isMenuVisible ? " menu-overlay-visible" : ""}${isBookingOpen ? " booking-overlay-open" : ""}`}
        suppressHydrationWarning
      >
        ...
        <div
          className="right"
          onClick={() => (isBookingOpen ? closeBooking() : openBooking("room"))}
        >
          <div>{isBookingOpen ? "Close" : "Book"}</div>
        </div>
      </header>
