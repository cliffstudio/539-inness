...
import michelinLogo from "@/app/images/michelin-logo.webp";
...
export default function Footer({ footer }: FooterProps) {
  ...
  const handleRevinateSubmit = (event: FormEvent<HTMLFormElement>) => {
    event.preventDefault();
    setRevinateSuccess(true);

    const windowWithRevForm = window as typeof window & {
      revFormOnSubmit?: () => void;
    };

    windowWithRevForm.revFormOnSubmit?.();
  };

  const revinateFormAttributes: FormHTMLAttributes<HTMLFormElement> & {
    token: string;
  } = {
    id: "revinate_contact_api_form",
    token: "129599f9-9ab1-4db3-8bd4-739d4f656ce7",
    onSubmit: handleRevinateSubmit,
    className: "revinate-contact-form",
  };
      ...
      return (
        <div key={linkIndex}>
          <a
            ...
            onClick={handleClick}
            {...((bookingTab === "table" || bookingTab === "golf") && {
              target: "_blank",
      ...
      <div key={linkIndex}>
        <a
          ...
          {...(link.linkType === "file" && {
            target: "_blank",
            rel: "noopener noreferrer",
            download: link.file?.asset?.originalFilename,
          })}
        >
          {text}
        </a>
    ...
    <footer className="site-footer h-pad">
      <div className="row-lg top">
        ...
        {footer.navigationColumn1 && (
          <div className="col-2-12_lg">
            {footer.navigationColumn1.heading && (
              <h5 className="site-footer__heading">
                {footer.navigationColumn1.heading}
              </h5>
            )}

            {footer.navigationColumn1.links &&
              footer.navigationColumn1.links.length > 0 && (
        ...
        {footer.navigationColumn2 && (
          <div className="col-2-12_lg">
            ...
            {footer.navigationColumn2.links &&
              footer.navigationColumn2.links.length > 0 && (
                <div className="site-footer__links">
        ...
        {footer.followColumn && (
          <div className="col-2-12_lg">
            ...
            {footer.followColumn.links &&
              footer.followColumn.links.length > 0 && (
                <div className="site-footer__links">
        ...
        {footer.contactColumn && (
          <div className="col-2-12_lg">
            ...
            {footer.contactColumn.contactItems &&
              footer.contactColumn.contactItems.length > 0 && (
                  ...
                  {footer.contactColumn.contactItems.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="site-footer__contact-item">
                        ...
                        <a
                          href={phoneHref}
                          className="site-footer__contact-phone"
                        >
                          {item.phoneNumber}
                        </a>
                        <span className="site-footer__contact-extension">
      ...
      <div className="row-lg bottom">
        <div className="col-6-12_lg">
          ...
          <form {...revinateFormAttributes}>
            <fieldset>
              <div className="site-footer__newsletter-heading body-big">
                Sign up to our newsletter
              </div>

              <div className="site-footer__newsletter-form-container">
                <div
                  className={`form-wrap${revinateSuccess ? " fade-out" : ""}`}
                >
                  <input
                    className="long"
                    type="email"
                ...
                <p
                  className={`site-footer__newsletter-success${revinateSuccess ? " fade-in" : ""}`}
                  aria-live="polite"
                >
        ...
        <div className="col-6-12_lg right-column">
          <div className="michelin-logo-wrap">
            <Image
              src={michelinLogo}
              alt="Michelin Guide"
              width={michelinLogo.width}
              height={michelinLogo.height}
            />
          ...
          <div>
            ...
            >
              ...
              <p className="credit-content">Site by Cliff.Studio</p>
            </a>
          </div>
        </div>
      </div>
