...
export default function Footer({ footer }: FooterProps) {
  ...
  const revinateFormAttributes: FormHTMLAttributes<HTMLFormElement> & { token: string } = {
      ...
      <div className="row-lg bottom">
        <div className="col-6-12_lg">
          ...
          <form {...revinateFormAttributes}>
            <fieldset>
              <div className="site-footer__newsletter-heading body-big">Sign up to our newsletter</div>

              <div className="site-footer__newsletter-form-container">
                <div className={`form-wrap${revinateSuccess ? ' fade-out' : ''}`}>
                  <input className="long" type="email" name="email" placeholder="Your email address" required />
